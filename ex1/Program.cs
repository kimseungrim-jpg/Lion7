...
namespace ex1
{
    class RPGCharacter
    {
        ...
        public void ShowStatus()
        {
            Console.WriteLine($"╔══════════════════════╗");
            Console.WriteLine();
            Console.WriteLine($"  레벨: {level,-14}");
            Console.WriteLine("╠══════════════════════╣");
            Console.WriteLine($"  HP: {hp}/{maxHP,-13}");
            Console.WriteLine($"  MP: {mp}/{maxMP,-12}");
            Console.WriteLine($" 공격력: {attack,-12}");
            Console.WriteLine($"  방어력: {defense,-12}");
            Console.WriteLine($"  경험치: {exp}/100{"",-6}");
            Console.WriteLine($"  골드: {gold,-14}");
            Console.WriteLine($"╚══════════════════════╝");
        }
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 캐릭터 생성
            RPGCharacter player = new RPGCharacter("용사", "마법사");
            RPGCharacter enemy = new RPGCharacter("어둠의 기사", "마법사");
